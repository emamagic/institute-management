...
export class AuthenticationService extends BaseService {
  ...
  static readonly VerifyCodePath = '/auth/verify';
   ...
   */
  refresh$Response(params?: Refresh$Params, context?: HttpContext): Observable<StrictHttpResponse<LoginResponse>> {
   ...
   * This method doesn't expect any request body.
   */
  refresh(params?: Refresh$Params, context?: HttpContext): Observable<LoginResponse> {
